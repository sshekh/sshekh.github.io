...
\begin{body}
  ...
  \begin{itemize}
  	...
  	\item Experimented with image based models by rendering stroke data to 
        ...
        %\item Achieved 40\% top-25 accuracy on 1.6k emoji classes
...
\begin{body}
  ...
  \begin{description}
    ...
    %      real time Semantic Segmentation of images using depth data on mobile devices. Currently
    %    exploring how depth values affect the performance of various

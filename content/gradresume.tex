...
\begin{body}
 \vspace{14pt}
  ...
  \begin{itemize}
  	\item Introduced Recurrent Neural Networks support in TMVA Module in the ROOT data analysis framework. Features include parsing network configurations, storing and loading weights, training data with GPU (using CuBLAS), BLAS and multi-threaded training
   support for CPUs.
